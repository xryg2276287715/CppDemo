...
void A::pointArray() {
    ...
    p23 = arr2[0];
    cout << "p20=" << p20 << ";p21=" << p21 << ";p22=" << p22 << ";p23=" << p23 << endl;
    ...
    //a0数组元素地址
    cout << "&a0[0]=" << &a0[0] << ";&a0[1]=" << &a0[1] << endl;
    //*a0:数组首元素的地址中存储的值，即对应的指针存储的地址，**a0:数组首元素地址存储上存储的指针对应的地址值->该地址上存放的取值
    cout << "*a0=" << *a0 << ";*a0+1=" << *a0 + 1 << "；**a0=" << **a0 << endl;
    //各指针地址上存放的具体值
    cout << "*a0[0]=" << *a0[0] << ";*a0[1]=" << *a0[1] << endl;

    cout << "---分隔 （指针数组）-映射乱序-----" << endl;
    int b1[3] = {'a', 'b', 'c'};
    int *a1[3] = {b1, &b1[2], &b1[1]};
    cout<<"b1[0]-addr="<<a1[0]<<";b1[1]-addr="<<a1[2]<<"b1[2]-addr="<<a1[1]<<endl;
    cout << "b1[0]-val=" << *a1[0] << ";b1[1]-val=" << *a1[2] << "b1[2]-val=" << *a1[1] << endl;
    cout << "b1[0]-val=" << **a1 << ";b1[0]-val=" << *a1[0]  << endl;
    cout << "b1[1]-val=" << *(*a1+1) << ";b1[1]-val=" << **(a1+2) << endl;
    cout << "b1[2]-val=" <<*(*a1+2) << ";b1[2]-val=" <<**(a1+1) << endl;
